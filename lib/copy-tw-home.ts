...
export const TW_HOME = {
  ...
  quests: {
    ...
    title: "讓日常消費變成額外現金回饋",
    intro:
      "任務是依照你的消費方式設計的自選挑戰。完成後可在原有回饋上再加碼，領到的是真實現金，不是點數。",
    cards: [
      {
        title: "連續消費",
        body: "在指定期間內完成多次消費，即可在原有回饋之外解鎖額外現金回饋。",
      },
      {
        title: "分類挑戰",
        body: "任務開放期間，在旅遊、電子產品或時尚等指定分類消費即可獲得加碼。",
      },
      {
        title: "檔期加碼",
        body: "大型促銷與活動期間提供限時回饋倍數，讓重要購物時刻回饋更多。",
      },
    ],
    stacking:
      "任務回饋會疊加在一般現金回饋上，每個完成的任務都是額外加碼。",
    cta: "查看進行中的任務",
  },
  howItWorks: {
    title: "三步驟，拿到第一筆現金回饋",
