...
export const TH_HOME = {
  ...
  quests: {
    ...
    intro:
      "เควสต์คือชาเลนจ์เสริมที่เข้ากับวิธีช้อปของคุณ ทำสำเร็จเพื่อรับแคชแบ็กเพิ่มจากอัตราปกติ เป็นเงินจริง ไม่ใช่แต้ม",
    cards: [
      {
        title: "ช้อปต่อเนื่อง",
        body: "ช้อปหลายครั้งภายในช่วงเวลาที่กำหนดเพื่อปลดล็อกแคชแบ็กเพิ่มจากอัตราที่ได้รับอยู่แล้ว",
      },
      {
        title: "ชาเลนจ์ตามหมวดหมู่",
        body: "รับเพิ่มเมื่อช้อปในหมวดที่ร่วมรายการ เช่น ท่องเที่ยว อิเล็กทรอนิกส์ หรือแฟชั่น ขณะที่เควสต์เปิดอยู่",
      },
      {
        title: "โบนัสตามฤดูกาล",
        body: "รับตัวคูณแคชแบ็กในช่วงเวลาจำกัดระหว่างแคมเปญและเทศกาลช้อปใหญ่",
      },
    ],
    stacking:
      "เควสต์รับเพิ่มจากแคชแบ็กปกติ ทุกเควสต์ที่ทำสำเร็จคือโบนัสเพิ่มเติม",
