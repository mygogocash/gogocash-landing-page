...
export const JA_HOME = {
  ...
  quests: {
    ...
    intro:
      "クエストは、買い方に合わせて参加できるチャレンジです。達成すると通常の還元にキャッシュバックが上乗せされます。ポイントではなく、実際のお金です。",
    cards: [
      {
        title: "連続購入",
        body: "期間内に複数回お買い物をすると、通常の還元に追加されるキャッシュバックを獲得できます。",
      },
      {
        title: "カテゴリチャレンジ",
        body: "開催中のクエストで、旅行、家電、ファッションなど対象カテゴリの追加還元を獲得できます。",
      },
      {
        title: "シーズンボーナス",
        body: "大型セールやキャンペーン期間中の限定倍率で、お買い物の還元をさらに増やせます。",
      },
    ],
    stacking:
      "クエストは通常のキャッシュバックに上乗せされ、達成するたびに追加還元を受け取れます。",
    cta: "開催中のクエストを見る",
  },
  howItWorks: {
